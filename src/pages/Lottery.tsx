...
import { Clover, Ticket, DollarSign, AlertCircle } from 'lucide-react'
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 mb-4">
                        ...
                        <span className="text-primary font-bold tracking-widest text-sm uppercase">{t('lottery.header_label')}</span>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="bg-surface-dark border border-white/10 rounded-3xl p-8 relative overflow-hidden group">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <div className="flex items-center justify-center gap-4 text-white/80 bg-white/5 py-4 rounded-2xl border border-white/5">
                                <DollarSign className="text-primary" />
                                <div className="text-left">
                                    <p className="text-xs text-gray-400 uppercase font-bold">{t('lottery.price_label')}</p>
                                    <p className="text-xl font-bold">23€ <span className="text-sm font-normal text-gray-500">{t('lottery.price_sub')}</span></p>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleReserve} className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-gray-100 dark:border-white/5">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <span className="text-3xl font-black text-primary">{tickets * 23}€</span>
                                </div>
